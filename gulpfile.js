...
gulp.task('clean', function() {
  return del(['dist', 'assets/css/main.css']);
});

// Copy libraries from node_modules into /vendor
...
gulp.task('dev', function browserDev(done) {
  ...
  gulp.watch('assets/js/script.js', gulp.series('js:minify', function jsBrowserReload (done) {
    browserSync.reload();
    done();
  }));
